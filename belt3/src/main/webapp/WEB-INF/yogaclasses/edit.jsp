...
<body>
    ...
    <h1>Change ${yogaClass.name}!</h1>
    <form:form action="/yogaclass/${yogaClass.id}/edityogaclass" method="POST" modelAttribute="yogaClass">
    ...
    <a href="/classes/${yogaClass.id}">Cancel</a>
        <c:if test="${isCurrentUser}">
        <form action="/yogaclass/${yogaClass.id}/delete" method="POST">
